...
public abstract class Hilt_HabitActionReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((HabitActionReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectHabitActionReceiver(UnsafeCasts.<HabitActionReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
